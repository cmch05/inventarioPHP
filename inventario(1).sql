...
--
-- Host: localhost
-- Generation Time: May 19, 2016 at 01:47 PM
...
INSERT INTO `cargo_empleado` (`serial`, `id_empleado`, `codigo_cargo`) VALUES
(0000000001, '94463816', '100'),
(0000000002, '94463815', '50');
...
('1115566675', 'OSCAR ANDRES CHAVEZ', 'CLL16  9-33', '3114292255', '2016-05-05', 600000.0, 1),
('94463815', 'MARIANA CORDOBA Sa', 'cr 10 # 15-44', '3214569988', '2016-05-12', 600000.0, 1),
...
--
-- Table structure for table `factura_compra__producto`
--
...
--
-- Indexes for table `bitacora_cambios`
--
...
--
-- Indexes for table `cargo_empleado`
--
...
--
-- Indexes for table `factura_compra__producto`
--
...
--
-- Indexes for table `producto_item`
--
...
--
-- Indexes for table `producto_recepcion`
--
...
--
-- AUTO_INCREMENT for table `bitacora_cambios`
--
ALTER TABLE `bitacora_cambios`
  MODIFY `serial` int(10) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `cargo_empleado`
--
ALTER TABLE `cargo_empleado`
  MODIFY `serial` int(10) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
ALTER TABLE `factura`
  MODIFY `serial` int(10) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `factura_compra__producto`
--
ALTER TABLE `factura_compra__producto`
  MODIFY `serial` int(10) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `producto_proveedor`
--
ALTER TABLE `producto_proveedor`
  MODIFY `serial` int(10) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `producto_recepcion`
--
ALTER TABLE `producto_recepcion`
...
--
-- Constraints for table `bitacora_cambios`
--
ALTER TABLE `bitacora_cambios`
...
--
-- Constraints for table `factura_compra__producto`
--
ALTER TABLE `factura_compra__producto`
...
--
-- Constraints for table `producto_item`
--
ALTER TABLE `producto_item`
...
--
-- Constraints for table `producto_recepcion`
--
ALTER TABLE `producto_recepcion`
